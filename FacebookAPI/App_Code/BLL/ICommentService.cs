...
namespace FacebookAPI.App_Code.BLL
{
    public interface ICommentService
    {
        ...
        public Task<List<CoreComment>> GetCommentsAsync(int currentUserId, int? userId = null, int? index = null, int? postId = null, bool? includeReplies = null, int? pictureId = null);
